            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="<?php echo base_url('toolkit/form_peminjaman/' . $row->id); ?>" method="post">
                    <div class="form-group">
                      <label for="peminjam">Pemegang</label>
                      <input type="text" name="id_pemegang" class="form-control" id="id_pemegang" value="<?php echo $row->id; ?>" hidden>
