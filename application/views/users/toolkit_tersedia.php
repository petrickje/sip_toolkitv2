  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
            ...
            <?php foreach ($toolkit as $row) { ?>
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                  ...
                  <div class="inner">
                    <h3>Toolkit</h3>
                    <p>Toolkit <?php echo $row->id; ?></p>
                  </div>
                  <div class="icon">
                    <i class="fas fa-toolbox"></i>
                  </div>

                  <a href="#toolkit<?php echo $row->id; ?>" type="button" class="small-box-footer" data-toggle="modal" data-target="#toolkit<?php echo $row->id; ?>">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
            <?php } ?>
          </div>
        ...
        <?php foreach ($toolkit as $row) { ?>
          <div class="modal fade" id="toolkit<?php echo $row->id; ?>">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title"> Toolkit <?php echo $row->id; ?></h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form action="<?php echo base_url('Toolkit/form_pengajuan/' . $row->id); ?>" method="post">
                    <div class="form-group">
                      <label for="peminjam">Pemegang</label>
                      <input type="text" name="id_pemegang" class="form-control" id="id_pemegang" value="<?php echo $row->pemegang_id; ?>" hidden>
                    ...
                    <input type="text" class="form-control" name="nim" value="<?php foreach ($users as $row) {
                                                                                echo $row->nim;
                                                                              } ?>" hidden>
                ...
                <div class="modal-footer justify-content-between">
                  ...
                  <input type="submit" class="btn btn-primary" value="Ajukan Pengajuan">
                  </form>
                </div>
              </div>
              <!-- /.modal-content -->
